...
public class fire extends Entity {
	...
	public fire(GamePanel gp, keyHandler keyH, int colorHP) { // colorHP: 1:green; 2:red;
		super();
		this.gp = gp;
		KeyH = keyH;
	...
	public void getImage() {
		...
		for (int i = 1; i <= 11; i++) {
			String path = "/res/PNG_Fire/05_1_atk/1_atk_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 19; i++) {
			String path = "/res/PNG_Fire/06_2_atk/2_atk_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 28; i++) {
			String path = "/res/PNG_Fire/07_3_atk/3_atk_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 8; i++) {
			String path = "/res/PNG_Fire/air_atk/air_atk_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 18; i++) {
			String path = "/res/PNG_Fire/08_sp_atk/sp_atk_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 10; i++) {
			String path = "/res/PNG_Fire/09_defend/defend_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 3; i++) {
			String path = "/res/PNG_Fire/03_jump_up/jump_up_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 3; i++) {
			String path = "/res/PNG_Fire/03_jump_down/jump_down_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 8; i++) {
			String path = "/res/PNG_Fire/02_run/run_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 13; i++) {
			String path = "/res/PNG_Fire/11_death/death_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 6; i++) {
			String path = "/res/PNG_Fire/10_take_hit/take_hit_" + i + ".png";
			try {
		...
		for (int i = 1; i <= 8; i++) {
			String path = "/res/PNG_Fire/01_idle/idle_" + i + ".png";
			try {
